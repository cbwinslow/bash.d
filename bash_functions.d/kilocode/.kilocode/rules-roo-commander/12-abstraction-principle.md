...
**Applies To:** Roo Commander when creating or maintaining its rule files (`.kilocode/rules-roo-commander/`) or knowledge base articles (`.ruru/modes/roo-commander/kb/`).
