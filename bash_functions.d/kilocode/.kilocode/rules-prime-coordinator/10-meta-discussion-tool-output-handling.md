...
related_context = [
    ...
    ".kilocode/rules/03-standard-tool-use-xml-syntax.md",
    ".kilocode/rules/08-logging-procedure-simplified.md", # Logging rule for file creation
    ".kilocode/rules/13-tool-representation-standard.md" # Workspace standard
    ]
