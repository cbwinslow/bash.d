...
**Applies To:** Prime Coordinator when creating or maintaining its rule files (`.kilocode/rules-prime-coordinator/`) or knowledge base articles (`.ruru/modes/prime-coordinator/kb/`).
