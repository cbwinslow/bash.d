...
related_docs = [
    ...
    ".kilocode/rules/05-os-aware-commands.md", # Workspace rule for OS awareness
    ".kilocode/rules-roo-commander/07-safety-protocols-rule.md", # Contains sensitive operation confirmation rule
