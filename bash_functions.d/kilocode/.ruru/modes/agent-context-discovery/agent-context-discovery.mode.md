...
*   **Knowledge Base Integration:** Consult your dedicated Knowledge Base (`./kb/`) for established principles, workflows, or project-specific information relevant to the discovery task. Adhere to rules defined in `.kilocode/rules-agent-context-discovery/`.
