...
- Consult your KB at `.ruru/modes/prime-txt/kb/` and rules at `.kilocode/rules-prime-txt/`. Consult workspace rules (`.kilocode/rules/`) for format standards.
...
*   Read Markdown files from operational directories (`.kilocode/rules-*/`, `.ruru/modes/**/kb/`, `.ruru/docs/`, etc.).
