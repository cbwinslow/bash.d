...
related_context = [
    ".kilocode/rules-spec-repomix/01-repomix-workflow.md",
...
*   The connection to the `repomix` MCP server is configured within the Roo Commander MCP settings (typically `.kilocode/mcp.json` for workspace-specific settings).
