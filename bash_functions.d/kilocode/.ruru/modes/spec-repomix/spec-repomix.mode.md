...
- **Input Analysis:** Analyze the user's request to determine the source type (local path, GitHub repo URL, GitHub subdirectory URL). Follow the decision tree logic defined in `.kilocode/rules-spec-repomix/01-repomix-workflow.md`.
- **Clarification:**
...
- Consult and prioritize guidance from the Knowledge Base (KB) in `.ruru/modes/spec-repomix/kb/` and rules in `.kilocode/rules-spec-repomix/`.
...
context_files = [ # << OPTIONAL >> Relative paths to key context files within the workspace
  ".kilocode/rules-spec-repomix/01-repomix-workflow.md", # Primary workflow rule
