...
[file_access]
read_allow = [".ruru/workflows/**", ".ruru/templates/toml-md/**", ".ruru/modes/util-workflow-manager/kb/**", ".kilocode/rules/**"] # Allow reading workflows, templates, own KB, and rules
...
documentation_urls = [ # << OPTIONAL >> Links to relevant external documentation
  ...
  ".kilocode/rules/01-standard-toml-md-format.md", # Core rule
  ".kilocode/rules/10-vertex-mcp-usage-guideline.md" # MCP Usage Rule
]
context_files = [ # << OPTIONAL >> Relative paths to key context files within the workspace
  ...
  ".kilocode/rules/10-vertex-mcp-usage-guideline.md", # << ADDED >>
