...
title = "Example .kilocode/mcp.json Configuration for Unsplash MCP Server"
context_type = "kb"
...
# Example `.kilocode/mcp.json` Configuration for Unsplash MCP Server

This file contains an example JSON structure for configuring the `upsplash-mcp-server` within the main `.kilocode/mcp.json` file, as referenced in the installation procedure `KB-MCP-MANAGER-UNSPLASH-V1.2`.
...
```json
// Example entry within the "servers" object in .kilocode/mcp.json
{
