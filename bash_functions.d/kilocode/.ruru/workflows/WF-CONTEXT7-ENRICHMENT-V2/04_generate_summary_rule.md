...
1.  **Delegate Rule Generation:**
    ...
    *   Instruct the agent to:
        *   Define the target rule directory: `[rule_dir] = .kilocode/rules-[mode_slug]/`. Ensure this directory exists (Prefer MCP `create_directory`, fallback `execute_command mkdir -p`).
