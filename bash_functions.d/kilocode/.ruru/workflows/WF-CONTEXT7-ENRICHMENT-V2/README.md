...
outputs = [ # (Array of Strings, Optional) Describe the expected final artifacts or outcomes.
    ...
    "Generated summary rule `.kilocode/rules-[mode_slug]/NN-context7-summary.md`.",
...
*   **Summary Rule:** A rule file (e.g., `.kilocode/rules-[mode_slug]/05-context7-summary.md`) summarizing the topics found in the Context7 KB.
