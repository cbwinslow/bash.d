...
3.  **Create if Missing:**
    *   `- [ ]` If the file does NOT exist:
        *   Prepare basic content for the usage strategy file (e.g., using a standard template or boilerplate text like below):
          ...
          1.  **Rules (`.kilocode/rules-[mode_slug]/`):** Mandatory operational constraints MUST be followed.
          ...
          5.  **General Project Rules (`.kilocode/rules/`):** Workspace-wide standards and conventions.
