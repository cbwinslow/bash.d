...
outputs = [ # (Array of Strings, Optional) Describe the expected final artifacts or outcomes.
    ...
    "An updated or created Context7 summary rule file at `.kilocode/rules-[mode_slug]/05-context7-summary.md` (or similar prefix).",
...
5.  Generating/updating a summary rule file (`.kilocode/rules-[mode_slug]/...`) reflecting the new KB content.
...
*   **Summary Rule:** An updated `.kilocode/rules-[mode_slug]/05-context7-summary.md` (or similar) file listing the topics covered in the refreshed KB.
