...
and creates/updates a rule file (`.kilocode/rules-[mode_slug]/05-context7-summary.md`) listing these topics.
...
outputs = [ # (Array of Strings, Optional) Data/artifacts produced by this step.
    "summary_rule_path: Path to the generated/updated summary rule file (e.g., .kilocode/rules-[mode_slug]/05-context7-summary.md).",
...
1.  **Define Paths:**
    ...
    *   `[rules_dir]` = `.kilocode/rules-[mode_slug]/`.
