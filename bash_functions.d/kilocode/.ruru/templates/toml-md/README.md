...
*   **`08_ai_context_source.md`**: For creating structured context files intended primarily for AI consumption (e.g., rules, best practices, API specs). Typically stored in `.ruru/context/` or `.kilocode/context/`. See `08_ai_context_source.README.md` for schema and usage details.
...
*   **`16_ai_rule.md`**: A minimalist template for defining rules intended for AI context injection (e.g., in `.kilocode/rules/`). See `16_ai_rule.README.md` for schema and usage details.
