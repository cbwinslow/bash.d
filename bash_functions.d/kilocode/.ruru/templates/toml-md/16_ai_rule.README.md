...
This template defines the structure for creating AI rule files, typically stored in `.kilocode/rules/`. These files provide specific instructions or constraints to AI assistants. The template is designed to be minimalist to optimize token count when included in AI prompts.

## Usage

1.  Copy `.ruru/templates/toml-md/16_ai_rule.md` to the target location (e.g., `.kilocode/rules/NN-rule-name.md`).
