...
owner = "Roo Commander"
related_docs = [
    ".kilocode/rules-spec-repomix/02-repomix-decision-tree.md",
...
*   `spec-repomix` Mode Definition (`.kilocodemodes`)
*   Rule: Repomix Source Identification & Config Workflow (`.kilocode/rules-spec-repomix/02-repomix-decision-tree.md`)
*   KB: Repomix Usage Corrections (`.ruru/modes/spec-repomix/kb/01-repomix-usage-corrections.md`)
*   Rule: Generate OS-Aware Commands (`.kilocode/rules/05-os-aware-commands.md`)
