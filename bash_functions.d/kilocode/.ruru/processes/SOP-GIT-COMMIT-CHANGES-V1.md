...
owner = "Roo Commander"
related_context = [".kilocode/rules/04-mdtm-workflow-initiation.md", "dev-git"] # As specified
...
*   `.kilocode/rules/04-mdtm-workflow-initiation.md` (If delegation involves MDTM)
